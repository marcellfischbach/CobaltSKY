...
uniform mat4 cs_ShadowMapMatProjView[6];
...
void main ()
{
	...
	gl_Position = cs_ShadowMapMatProjView[3] * gl_in[0].gl_Position;
	inFragTexCoord = inGeomTexCoord[0];
	inFragNormal = inGeomNormal[0];
	EmitVertex ();
	gl_Position = cs_ShadowMapMatProjView[3] * gl_in[1].gl_Position;
	inFragTexCoord = inGeomTexCoord[1];
	inFragNormal = inGeomNormal[1];
	EmitVertex ();
	gl_Position = cs_ShadowMapMatProjView[3] * gl_in[2].gl_Position;
	inFragTexCoord = inGeomTexCoord[2];
	inFragNormal = inGeomNormal[2];
	EmitVertex ();
	...
	gl_Position = cs_ShadowMapMatProjView[4] * gl_in[0].gl_Position;
	inFragTexCoord = inGeomTexCoord[0];
	inFragNormal = inGeomNormal[0];
	EmitVertex ();
	gl_Position = cs_ShadowMapMatProjView[4] * gl_in[1].gl_Position;
	inFragTexCoord = inGeomTexCoord[1];
	inFragNormal = inGeomNormal[1];
	EmitVertex ();
	gl_Position = cs_ShadowMapMatProjView[4] * gl_in[2].gl_Position;
	inFragTexCoord = inGeomTexCoord[2];
	inFragNormal = inGeomNormal[2];
	EmitVertex ();
	...
	gl_Position = cs_ShadowMapMatProjView[5] * gl_in[0].gl_Position;
	inFragTexCoord = inGeomTexCoord[0];
	inFragNormal = inGeomNormal[0];
	EmitVertex ();
	gl_Position = cs_ShadowMapMatProjView[5] * gl_in[1].gl_Position;
	inFragTexCoord = inGeomTexCoord[1];
	inFragNormal = inGeomNormal[1];
	EmitVertex ();
	gl_Position = cs_ShadowMapMatProjView[5] * gl_in[2].gl_Position;
	inFragTexCoord = inGeomTexCoord[2];
	inFragNormal = inGeomNormal[2];
	EmitVertex ();

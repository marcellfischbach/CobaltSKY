...
#include <cobalt/loaders/entity/csrenderstatexmlloader.refl.hh>
...
* \ingroup loading
*/
class CSE_API csRenderStateXMLLoader : public CS_SUPER(csSpatialStateXMLLoader)
{
  CS_CLASS_GEN;
public:
  csRenderStateXMLLoader();
  virtual ~csRenderStateXMLLoader();

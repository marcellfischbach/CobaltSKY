...
#include <cobalt/loaders/entity/csdynamiccolliderstatecsfloader.refl.hh>

CS_CLASS()
class CSE_API csDynamicColliderStateCSFLoader : public CS_SUPER(csBaseColliderStateCSFLoader)
{
  CS_CLASS_GEN;
public:
  csDynamicColliderStateCSFLoader();
  virtual ~csDynamicColliderStateCSFLoader();

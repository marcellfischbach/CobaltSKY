...
class CSGRAPHICSGL4_API ShaderGraphGL4 : public CS_SUPER(cs::iSGShaderGraphFactory)
{
public:
  ShaderGraphGL4(cs::GraphicsGL4 * graphics);
  ~ShaderGraphGL4();
  ...
  cs::SGNodeGL4* CreateNode(const cs::Class * nodeClass);

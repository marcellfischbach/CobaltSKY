...
CS_CLASS()
class CSE_API PropertySetter : public cs::Object
{
	CS_CLASS_GEN;
public:
...
CS_CLASS()
class CSE_API PropertySetterWrapper : public CS_SUPER(cs::ResourceWrapper)
{
	CS_CLASS_GEN;
	CS_RESOURCE_WRAPPER(cs::PropertySetter, PropertySetterWrapper, cs::ResourceWrapper);
};

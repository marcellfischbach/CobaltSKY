...
const cs::Class* iObject::GetClass() const
{
  return cs::iObjectClass::Get();
}

const cs::Class* iObject::GetStaticClass()
{
  return cs::iObjectClass::Get();
}
...
{
  throw cs::InstanciationException("cs::iObject");
}
...
cs::iObject* ObjectClass::CreateInstance() const
{
  return static_cast<cs::iObject*>(new Object());
}
...
void* Object::QueryClass(const Class* clazz)
{
  ...
  void* super = nullptr;
  super = cs::iObject::QueryClass(clazz);
  if (super)
  {
    return super;
  }

...
#define CHECK_IDX(tokens, idx) if ((idx) >= tokens.size()) throw cs::moc::ParseException(__FILE__, __LINE__, "Index out of boundx " + std::to_string(idx) + " >= " + std::to_string(tokens.size()))
